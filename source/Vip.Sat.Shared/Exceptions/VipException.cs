...
namespace Vip.Sat.Exceptions
{
    public class VipException : ApplicationException
    {
        ...
        /// </param>
        public VipException(string message, Exception innerException)
        ...
        /// <param name="args">The arguments.</param>
        public VipException(Exception innerException, string message, params object[] args)
